<?php
ob_start();
define('API_KEY',' 1717159770:AAH5qgW826WpA4i9bsFvq5xTYDerprekQ7I ');
$admin = " 1261391970 "; //admin id
$kanalimz =" @ismlarga_rasmlar_va_harflar"; //kanal useri
   function del($nomi){
...
$balinfo = "Salom🖐 Bu bot orqali siz AMERIKA (usa) 🇺🇸Nomer olib telegram ochishingiz mumkin.☝️ Botdan foydalanish uchun $kanalimz kanaliga obuna bo'lishingiz kerak.";
